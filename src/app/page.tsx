    ...
    <section className="w-full">
      <div className="container mx-auto px-4 py-16 md:py-32 text-center">
        ...
        <p className="text-muted-foreground text-lg md:text-xl mb-8 max-w-2xl mx-auto">
          Platform ini adalah proyek pribadi oleh <span className="text-foreground font-semibold">Candra Pramudya Arunita</span>, dibuat untuk membagikan drama pendek terbaik kepada dunia.
        </p>
